...
var collectionControlsUploadOverlay = uploadOverlay.querySelectorAll('.upload-effect-label');
...
function renderPicturesBlock(usersPhotosArr) {
...
function openUploadOverlay(){
    ...
    addCollectionElHandlers(collectionControlsUploadOverlay, {'click': itemEffectControlClick});
    addRemoveHandlers([
...
function closeUploadOverlay(){
    ...
    removeCollectionElHandlers(collectionControlsUploadOverlay, {'click': itemEffectControlClick});
...
function itemEffectControlClick(evt) {
    ...
    var elementStyle = element.getAttribute('for').replace('upload-', '');
...
function onButtonResizeClick(evt){
    ...
    var controlValue = parseInt(elementModyfiing.getAttribute('value'));
    var controlValueStep = parseInt(elementModyfiing.getAttribute('step'));
    var controlValueMax = parseInt(elementModyfiing.getAttribute('maxlength'));
    var controlValueMin = parseInt(elementModyfiing.getAttribute('minlength'));
...
function removeCollectionElHandlers(collection, obj) {
    var eventHandlers = obj;
    collection.forEach(function (item) {
        for (var key in eventHandlers) {
            item.removeEventListener(key , eventHandlers[key]);
        }
    });
}
...
function init(){
    usersPhotosArr = createPhotosObject();
